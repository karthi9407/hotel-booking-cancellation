...
*Answer: What are we predicting, for whom, and at what moment in time?*
...
*Answer: What's in the dataset, and what did you find in EDA that shaped your decisions?*
...
*Answer: Which columns did you drop and why?*
...
*Answer: How did you split the data and why did you choose that approach over random splitting?*
...
*Answer: What features did you create or transform, and why?*
...
*Answer: What did you try, what won, and why do you think it won?*
...
We tried three models: logistic regression, random forest, and XGBoost. XGBoost performed best with a validation AUC of 0.835. On the final test set (June–August 2017), AUC dropped to 0.796, likely because the test set covers summer peak season which may have different cancellation patterns than the training period.

[Write 3–4 sentences on why XGBoost won (better handling of non-linear interactions, native class imbalance weighting) and why Random Forest underperformed LR (RF importance diluted by one-hot encoded features; LR benefited from clean engineered features).]

---

## 7. Threshold Tuning

*Answer: Why didn't you use the default 0.5 threshold, and how did you choose the final one?*
...
*Answer: If you had another week, what would you improve?*
...
*Answer: What did building this teach you that you didn't know before?*
